(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'uuid-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'uuid-jsLegacy'.");
    }root['uuid-jsLegacy'] = factory(typeof this['uuid-jsLegacy'] === 'undefined' ? {} : this['uuid-jsLegacy'], kotlin);
  }
  ...
  var setVersion = defineInlineFunction('uuid-jsLegacy.com.benasher44.uuid.setVersion_767k4w$', wrapFunction(function () {
    var toByte = Kotlin.toByte;
  ...
  $$importsForInline$$['uuid-jsLegacy'] = _;
  ...
  Kotlin.defineModule('uuid-jsLegacy', _);
  return _;
}));

//# sourceMappingURL=uuid-jsLegacy.js.map
